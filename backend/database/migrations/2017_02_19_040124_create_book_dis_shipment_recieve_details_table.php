...
class CreateBookDisShipmentRecieveDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('book_dis_shipment_recieve_details', function (Blueprint $table) {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::drop('book_dis_shipment_recieve_details');
    }
}
