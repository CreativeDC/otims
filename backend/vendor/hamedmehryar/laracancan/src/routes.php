...
Route::group(['middleware' => ['web']], function () {
    ...
    /////////////////// User /////////////////////////////////////////////////////////////////////
    Route::resource('lccuser', 'Hamedmehryar\Laracancan\Controllers\UserController');
    Route::group(['prefix'=> 'lccuser'], function(){
        Route::get('/{id}/manage_user_roles',['as'=>'lccuser.manageRoles', 'uses'=>'Hamedmehryar\Laracancan\Controllers\UserController@manageRoleUsers']);
        Route::post('/{id}/manage_user_roles',['as'=>'lccuser.postManageRoles', 'uses'=>'Hamedmehryar\Laracancan\Controllers\UserController@manageRoleUsersAction']);
    });
    ///////////////////////////////////////////////////////////////////////////////////////////////
});